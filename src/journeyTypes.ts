...
// ============================================================
// The journey: a long goal broken into stages you can reach.
//
...
//
// Once a stage is on the ladder it never moves, and once it is
...
/** Which strand of the climb a stage belongs to. */
export type TrackId = 'body' | 'strength' | 'engine' | 'explosive' | 'consistency'

/**
 * What a stage is measured on.
 *
 ...
 *
 * stageId → the day it was first reached. Append-only: never
 ...
 * goal re-adopt a stage they already earned.
 *
 * This is persisted and the rest is derived, because a reached stage
