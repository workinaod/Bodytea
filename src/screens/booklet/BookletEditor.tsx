        ...
        <Card className="space-y-3">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl bg-surface-2 px-3 py-2.5 text-[14px] font-bold outline-none focus:ring-accent/45"
            />
          </div>
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="mt-1 w-full resize-none rounded-xl bg-surface-2 px-3 py-2.5 text-[13px] font-semibold outline-none focus:ring-accent/45"
            />
          </div>
            ...
            <Card key={wd} className="!py-3">
              <div className="flex items-center justify-between gap-2">
                ...
                {t ? (
                  ...
                  <button
                    onClick={() => addDay(wd)}
                    className="flex-1 rounded-xl bg-surface-2 border-2 border-edge py-2 text-[12.5px] font-bold text-ink-faint"
                  >
                    + add a training day
                  </button>
                )}
    ...
    <Sheet open onClose={onClose} title="Edit day">
      <div className="space-y-4 pb-8">
        <input
          ...
          className="w-full rounded-xl bg-surface-2 border-2 border-edge px-3 py-2.5 text-[15px] font-black outline-none focus:ring-accent/45"
        />
        ...
        <div className="space-y-2">
          {template.entries.map((e, i) => {
            ...
            return (
              <div key={i} className="rounded-xl bg-surface-2 border-2 border-edge p-3">
                <div className="flex items-center justify-between gap-2">
