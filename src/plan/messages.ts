...
export const MESSAGE_POOLS: MessagePool[] = [
  ...
  // ---------- "Need a push" ----------
  {
    ...
    situation: 'push',
    variants: [
      "Be honest: you're not tired, you're comfortable. Comfortable never built anything you're proud of.",
      'You said it yourself: "{goal}" Sitting here isn\'t a step toward that. Forty minutes is.',
      "You already know how tonight feels if you skip. That low-grade mad-at-yourself while you scroll. Skip that feeling instead.",
      "Deal: just do the warmup. If you genuinely want out after, leave. You never do.",
      "Motivation shows up around set two. It never shows up on the couch. Start without it.",
      "The person you're trying to become trains on days exactly like this. That's the whole difference between them and everyone else.",
      "An hour from now this is either done and you feel unstoppable, or it's still hanging over you. Same hour either way.",
      "Your body keeps every deposit. Better sleep tonight, more energy tomorrow, a mirror that slowly starts agreeing with you.",
      "You'll spend more time on your phone tonight than this session takes. Trade 40 of those minutes.",
      "Six months from now you'll wish you'd started today. Good news: today's still here.",
    ],
  },
