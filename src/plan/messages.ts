...
export const MESSAGE_POOLS: MessagePool[] = [
  ...
  // ---------- "Need a push" ----------
  {
    ...
    situation: 'push',
    variants: [
      "You don't need motivation, you need the first exercise. Start the clock, do the warm-up. The rest follows.",
      'Feeling lazy is data, not destiny. Real fatigue has a readiness check. Pass it and this is just resistance, which folds in about 4 minutes.',
      'The you that dunks in a year is built entirely on days like this one.',
      "Deal: do the 10-minute minimum. If you still want to stop after, stop. You won't.",
      'Nobody feels like it. The dunkers, the shredded guys, the fast ones. None of them felt like it either. They just start sooner.',
      "Past-you set the goal. Future-you enjoys it. Present-you has one job: today's session. Clock in.",
      'The rim is 10 feet today, tomorrow, and in July. The only variable is you. Move the variable.',
      "Skipping feels good for an hour. Training feels good for two days. You're a DJ, you get delayed drops. This is one.",
      "Show up and the plan works. It's not magic, it's arithmetic. Don't break the math today.",
