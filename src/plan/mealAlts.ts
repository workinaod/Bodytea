...
export const COMMON_MEALS: CommonMeal[] = [
  ...
  { id: 'chicken-rice', name: 'Chicken & rice', ingredients: ['6 oz chicken breast', '1.5 cups rice', 'oil or butter'], proteinG: 47, kcal: 590, slots: ['lunch', 'dinner'], diet: 'omni' },
  ...
  { id: 'chicken-stirfry', name: 'Chicken stir-fry over rice', ingredients: ['6 oz chicken', 'frozen veg', '1 cup rice', 'soy sauce + oil'], proteinG: 48, kcal: 635, slots: ['dinner'], diet: 'omni' },
  ...
  { id: 'chicken-salad', name: 'Grilled chicken salad', ingredients: ['6 oz chicken', 'bagged greens', 'dressing', 'croutons'], proteinG: 45, kcal: 550, slots: ['lunch', 'dinner'], diet: 'omni' },
  ...
  { id: 'mac-chicken', name: 'Mac & cheese + chicken', ingredients: ['1 cup mac & cheese', '4 oz chicken'], proteinG: 37, kcal: 500, slots: ['lunch', 'dinner'], diet: 'omni' },
